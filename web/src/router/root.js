...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'teacherShow',
        name: 'teacherShow',
        component: () => import('/@/views/index/teacher.vue'),
      },
      {
        path: 'qicaiShow',
        name: 'qicaiShow',
        component: () => import('/@/views/index/qicai.vue'),
      },
      {
        path: 'detail',
        name: 'detail',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'teacher', name: 'teacher', component: () => import('/@/views/admin/teacher.vue') },
      { path: 'qicai', name: 'qicai', component: () => import('/@/views/admin/qicai.vue') },
