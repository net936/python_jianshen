  ...
  <div class="hd">
    <div class="main-bar-view">
      ...
      <div class="right-view">
        ...
        <!--        <a class="link" @click="handleJoin()">课程入驻</a>-->
...
<script setup>
  ...
  let menuData = ref([
    { link: 'home', title: '首页' },
    { link: 'recommend', title: '课程推荐' },
    { link: 'teacherShow', title: '教练风采' },
    { link: 'qicaiShow', title: '器材展示' },
  ...
  watch(
    ...
    (newPath, _) => {
      ...
      }else if (newPath.indexOf('/index/teacherShow') > -1) {
        selectedMenu.value = 'teacherShow';
      }else if (newPath.indexOf('/index/qicaiShow') > -1) {
        selectedMenu.value = 'qicaiShow';
      }
    },
    { immediate: true },
  );
