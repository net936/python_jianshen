...
urlpatterns = [
    ...
    path('admin/teacher/list', views.admin.teacher.list_api),
    path('admin/teacher/create', views.admin.teacher.create),
    path('admin/teacher/update', views.admin.teacher.update),
    path('admin/teacher/delete', views.admin.teacher.delete),
    path('admin/qicai/list', views.admin.qicai.list_api),
    path('admin/qicai/create', views.admin.qicai.create),
    path('admin/qicai/update', views.admin.qicai.update),
    path('admin/qicai/delete', views.admin.qicai.delete),
    ...
    path('index/teacher/list', views.index.teacher.list_api),
