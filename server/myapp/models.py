...
class Thing(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.SET_NULL, blank=True, null=True,
                                related_name='teacher_thing')  # 约束类型是SET_NULL
    ...
    level = models.CharField(max_length=50, blank=True, null=True)  # 级别（初级/中级/高级）
    shiyong = models.CharField(max_length=20, blank=True, null=True)  # 适用人群
    xiaoguo = models.CharField(max_length=20, blank=True, null=True)  # 目标效果
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Qicai(models.Model):
    list_display = ("title", "id")
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=100, blank=True, null=True)  # 名称
    desc = models.CharField(max_length=100, blank=True, null=True)  # 简介
    status = models.CharField(max_length=10, blank=True, null=True)  # 状态
    cover = models.ImageField(upload_to='cover/', null=True)  # 头像
    create_time = models.DateTimeField(auto_now_add=True, null=True)
