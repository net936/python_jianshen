...
from myapp.models import Thing, Classification, User, Comment, Record, LoginLog, Order, OpLog, \
    Ad, Notice, ErrorLog, Feedback, Teacher, Qicai


class ThingSerializer(serializers.ModelSerializer):
    # 额外字段
    classification_title = serializers.ReadOnlyField(source='classification.title')
    teacher_title = serializers.ReadOnlyField(source='teacher.title')
...
class QicaiSerializer(serializers.ModelSerializer):
    class Meta:
        model = Qicai
        fields = '__all__'
